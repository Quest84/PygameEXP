...
player_image = pygame.image.load('images/idle/frog_r.png')#.convert()
player_image_mirror = pygame.image.load('images/idle/frog_l.png')

player_image_jump = pygame.image.load('images/jump/frog_jump_r.png')

player_image_jump_mirror = pygame.image.load('images//jump/frog_jump_l.png')
...
while GAME_ON:  # Loop del Juego
	...
	pygame.draw.rect(display,(70,90,75), pygame.Rect(0,120,300,80))
